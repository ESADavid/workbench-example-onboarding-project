...
PROJECT_NAME = "nvidia-api-project"
PYTHON_PACKAGES = ["requests"]
JUPYTER_NAME = "jupyterlab"
CODE_DIR = "/code"
CODE_FILE = "nvidia_api.py"
...
def package_setup():
    ...
    for pkg in PYTHON_PACKAGES:
        testing.ensure_package(PROJECT_NAME, "pip", pkg)


def create_web_app():
    """Wait for the API code to probably exist."""
    project = testing.get_project(PROJECT_NAME)
    ...
    if b"class NvidiaAPI" not in contents:
